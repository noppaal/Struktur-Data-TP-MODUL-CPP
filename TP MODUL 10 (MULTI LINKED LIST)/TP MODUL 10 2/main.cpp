...
int main()
{
    ...
    if(P!=NULL){
        cout << "Penerbangan dari surabaya ke malang pada tanggal 9desember2022 ditemukan" << endl;
        cout << "Kode penerbangan" << " " << info(P).Kode << ", " << "jenis pesawat" << " " << info(P).Jenis << ", "
        << "tanggal penerbangan" << " " << info(P).Tanggal << ", " << "waktu" << " " << info(P).Waktu << ", " << "asal"
        << " " << info(P).Asal << ", " << "tujuan" << " " << info(P).Tujuan << ", " << "dengan kapasitas" << " "<<info(P).Kapasitas << " Orang" << endl;
    }else{
        cout << "Penerbangan dari surabaya ke malang pada tanggal 9desember2022 tidak ditemukan";
    }
    return 0;
}
